...
import { formInput, formSubmit } from './feedback/form-event';
import { common } from './feedback/common';

common.form.addEventListener('input', common.throttle(formInput, 500));
common.form.addEventListener('submit', formSubmit);
